...
static void distanceFunc(sqlite3_context *context, int argc, sqlite3_value **argv)
{
	...
	double km_res =  acos(sin(lat1rad) * sin(lat2rad) + cos(lat1rad) * cos(lat2rad) * cos(DEG2RAD(lon2) - DEG2RAD(lon1))) * 6378.1;
	sqlite3_result_double(context, km_res * 1000);
}
...
- (BOOL)open {
	...
	sqlite3_create_function(db, "dist", 4, SQLITE_UTF8, NULL, &distanceFunc, NULL, NULL);
