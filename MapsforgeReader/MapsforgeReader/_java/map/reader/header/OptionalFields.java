...
final class OptionalFields {
	...
	private FileOpenResult readMapStartPosition(ReadBuffer readBuffer) {
		if (this.hasStartPosition) {
			...
			if (mapStartLatitude < RequiredFields.LATITUDE_MIN || mapStartLatitude > RF_LATITUDE_MAX) {
			...
			if (mapStartLongitude < RequiredFields.LONGITUDE_MIN || mapStartLongitude > RF_LONGITUDE_MAX) {
